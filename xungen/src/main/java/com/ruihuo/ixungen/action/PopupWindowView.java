...
public class PopupWindowView extends PopupWindow {
    ...
    private PopupWindowInterface mCallBack;
    ...
    public void setOneText(String content, final PopupWindowInterface mCallBack) {
    ...
    public void setTwoText(String content, final PopupWindowInterface mCallBack) {
    ...
    public void setThreeText(String content, final PopupWindowInterface mCallBack) {
