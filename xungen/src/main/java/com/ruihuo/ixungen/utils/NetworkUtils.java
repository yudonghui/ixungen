...
public class NetworkUtils {
    ...
    public static boolean isNetworkAvailable() {
        boolean flag = false;
        ConnectivityManager manager = (ConnectivityManager) XunGenApp.getInstance()
...
//
    ...
    public static class NetworkReceiverUtil {
        ...
        public static void registNetworkReceive(Context context, BroadcastReceiver networkReceiver) {
            if (context == null || networkReceiver == null) return;
            try {
    ...
    public static String getIPAddress() {
        NetworkInfo info = ((ConnectivityManager) XunGenApp.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
        if (info != null && info.isConnected()) {
            if (info.getType() == ConnectivityManager.TYPE_MOBILE) {//当前使用2G/3G/4G网络
                ...
                WifiManager wifiManager = (WifiManager) XunGenApp.getInstance().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
