...
public class AgnationNewActivity extends AppCompatActivity {
    ...
    private String id;//宗亲id

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_agnation_new);
        mContext = this;
        //本宗亲会id
    ...
    private void initView() {
        mBack = findViewById(R.id.image_titlebar_back);
        mRefresh = findViewById(R.id.refresh);
        mRight_icon = (ImageView) findViewById(R.id.right_icon);
        mRight_status = findViewById(R.id.right_status);
        mImage_header = findViewById(R.id.image_header);
        mAgnation_name = (TextView) findViewById(R.id.agnation_name);
        mAgnation_introduce = (TextView) findViewById(R.id.agnation_introduce);
        mAgnation_detail = (TextView) findViewById(R.id.agnation_detail);
    ...
    View.OnClickListener SaoSaoListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(AgnationNewActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, ConstantNum.PERMISSION_CAMERA);
            } else {
                //调取二维码扫描
