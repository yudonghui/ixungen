        ...
        mHttp.get(Url.CITY_URL, params, new JsonInterface() {
            ...
            public void onSuccess(String result) {
                ...
                if (cityModel.getCode() == 200) {
                    ...
                    HintDialogUtils hintDialogUtils = new HintDialogUtils(SelectCityActivity.this);
    ...
    private void addListener() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SelectCityActivity.this, SelectShiActivity.class);
                intent.putExtra("cityId", data.get(position).getId() + "");
                intent.putExtra("cityName", data.get(position).getName());
