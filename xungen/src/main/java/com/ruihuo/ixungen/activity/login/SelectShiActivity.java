        ...
        mHttp.get(Url.CITY_URL, params, new JsonInterface() {
            ...
            public void onSuccess(String result) {
                ...
                if (cityModel.getCode() == 200) {
                    ...
                    HintDialogUtils hintDialogUtils=new HintDialogUtils(SelectShiActivity.this);
    ...
    private void addListener() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SelectShiActivity.this, SelectXianActivity.class);
                intent.putExtra("cityId", data.get(position).getId() + "");
                intent.putExtra("address",cityId+","+data.get(position).getId());
