 ...
 */
public class CatalagView2 extends LinearLayout {
    private Context mContext;
    private View mInflate;
    private ExpandableListView mListView;
    private CatalagAdapter mAdapter;

    public CatalagView2(Context context) {
        super(context);
        mContext = context;
        mInflate = View.inflate(context, R.layout.catalag_view2, this);
        initView();
    }

    public CatalagView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        mInflate = View.inflate(context, R.layout.catalag_view2, this);
        initView();
